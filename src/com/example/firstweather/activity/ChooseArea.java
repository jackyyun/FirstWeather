...
public class ChooseArea extends Activity {
    ...
    private void queryCities(){
    	 cityList = firstWeatherDB.loadCity(selectedProvince.getId());
    	 if(cityList.size()>0){
    		 dataList.clear();
    ...
    private void queryCounties(){
    	countyList = firstWeatherDB.loadCounty(selectedCity.getId());
    	...
    	HttpUtil.sendHttpRequest(address, new HttpCallbackListener(){
    		...
    		public void onFinish(String response){
    			...
    			if("province".equals(type)){
    				...
    				result = Utility.handleCountiesResponse(firstWeatherDB,response,selectedCity.getId());
    			}
    			if(result){
    		...
    		public void onError(Exception e){
    			runOnUiThread(new Runnable(){
    				public void run(){
    					closeProgressDialog();
    					Toast.makeText(ChooseArea.this,"load fail",Toast.LENGTH_SHORT).show();
    				}
    			});
    		}
